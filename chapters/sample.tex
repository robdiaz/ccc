...
\marginfig[-2in]{graphics/f01Faraday}{Faraday's law.\label{fig:George}}
...
\inlinefig{graphics/f03ReflectanceLab}{Experimental setup.}
...
\begin{figure}[b]
    \inneralign{\includegraphics{graphics/f08Young}}
...
\personfeature[-1in]{graphics/f00Descartes}{Ren\'{e}
